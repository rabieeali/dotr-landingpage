...
export default function Index() {
  return (
    <>
      ...
      >
        <div className="container w-full flex justify-center lg-justify-end ml-auto flex-wrap">
          <div className="text-center m-auto">
            <div className="w-full text-right lg:text-center  flex flex-col justify-center sm:pt-0">
              <h2 className="rtl font-semibold w-full text-hero text-white ">
                <Typewriter
                  options={{
                    autoStart: true,
                    loop: true,
                  ...
                  onInit={(typewriter) => {
                    typewriter
                      .typeString(" راه حل نهایی مسائل شما")
                      .pauseFor(2500)
                      .deleteAll()
      ...
      <section className=" pb-40 relative bg-blueGray-100">
            ...
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg  bg-darkBlue-700">
                ...
                <blockquote className="relative p-8 mb-4">
                  <FaInfoCircle className="text-right text-5xl" />
                  <h4 className="text-xl font-bold text-right text-right">
                    درباره ما
                  </h4>
                  <p className="text-md font-light mt-2 text-center">
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48 text-center">
              <div className="text-blueGray-500 p-3 text-right inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                <FaSitemap className="text-xl text-center flex justify-center mx-auto text-center" />
              </div>
            ...
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto mt-32">
              <div className="relative flex flex-col min-w-0 w-full mb-6 mt-48 md:mt-0">
                <img className="rounded-lg" src={Gif3} alt="pic" />
              </div>
            </div>
          </div>

          <div id="nav-software" className="flex flex-wrap items-center pt-28">
              ...
              <div className="justify-center flex flex-wrap relative">
                ...
                <div className="my-4 w-full lg:w-6/12 px-4 lg:mt-16">
                  <div className="bg-card-600 shadow-lg rounded-lg text-center p-8">
                    ...
                    />
                    <p className="text-sm text-white mt-4 font-semibold">
                      برنامه نویسی و ارائه راهکارهای مبتنی بر نرم افزار به سفارش
                      مشتری{" "}
                    </p>
                  </div>
            ...
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48 text-center">
              <div className="text-blueGray-500 p-3 text-center inline-flex justify-center text-center mx-auto items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                <FaDraftingCompass className="text-xl flex justify-center text-center mx-auto " />
              </div>
              <h3 className="text-3xl mb-2 font-semibold leading-normal text-right">
                محصولات نرم افزاری
              </h3>
        ...
        <div
          id="nav-network"
          className="container mx-auto px-4 pb-32 pt-48 text-right"
        >
          <div className="items-center flex flex-wrap">
            ...
            <div className="w-full md:w-6/12 mr-auto px-4 pt-24 md:pt-0">
              <img
                ...
                src={require("assets/img/gif-5.gif").default}
              />
            </div>
          </div>
        </div>
      ...
      <section className="px-4 mb-24 lightbox">
      ...
      <section className=" bg-blueGray-600 overflow-hidden">
        <div className="container mx-auto pb-64">
          <div className="flex flex-wrap justify-center space-x-10">
            <div className="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64"></div>
            ...
            <div className="w-full text-center lg:w-8/12">
              ...
              <div className="text-blueGray-500 text-lg leading-relaxed mt-4 mb-4">
                ...
                >
                  ...
                  <a
                    href="https://www.linkedin.com/in/dotrco-andishe-hoshmand-78468122a"
                    target="_blank"
                  >
                    <div className="space-y-10 flex flex-col items-center">
                      <FaLinkedin />
                  ...
                  <a href="https://www.instagram.com/dotr.co/" target="_blank">
                    <div className="space-y-10 flex flex-col items-center">
                      <FaInstagramSquare />
