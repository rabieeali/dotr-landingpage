...
export default function Modal(props) {
  ...
  return (
    <div className="">
      <button
        className="bg-pink-500  text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
            ...
            >
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="bg-lightBlue-200 text-blueGray-700 flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  ...
                  <button
                    className="m-4 bg-emerald-500 text-white active:bg-emerald-600 font-bold  text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150"
                    type="button"
                    // onClick={() => setShowModal(false)}
